...
public class VisionService {
  ...
  public interface Iface {
    ...
    public Output applyFilter(Filter filter) throws org.apache.thrift.TException;

    public Output applyFilterChain(List<Filter> filters) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Output recv_applyFilter() throws org.apache.thrift.TException
    {
    ...
    public Output recv_applyFilterChain() throws org.apache.thrift.TException
    {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.filters = new ArrayList<Filter>(_list20.size);
                  Filter _elem21;
                  for (int _i22 = 0; _i22 < _list20.size; ++_i22)
                  {
                    _elem21 = new Filter();
                    _elem21.read(iprot);
                    struct.filters.add(_elem21);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, applyFilterChain_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.filters != null) {
          oprot.writeFieldBegin(FILTERS_FIELD_DESC);
          {
            ...
            for (Filter _iter23 : struct.filters)
            {
              _iter23.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class applyFilterChain_argsTupleScheme extends TupleScheme<applyFilterChain_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, applyFilterChain_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        {
          ...
          for (Filter _iter24 : struct.filters)
          {
            _iter24.write(oprot);
          }
        }
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, applyFilterChain_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        {
          ...
          struct.filters = new ArrayList<Filter>(_list25.size);
          Filter _elem26;
          for (int _i27 = 0; _i27 < _list25.size; ++_i27)
          {
            _elem26 = new Filter();
            _elem26.read(iprot);
            struct.filters.add(_elem26);
          }
        }
        struct.setFiltersIsSet(true);
      }
